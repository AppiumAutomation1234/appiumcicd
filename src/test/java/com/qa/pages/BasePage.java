...
/*    public void swipe(int startX, int startY, int endX, int endY, int millis)
    ...
    public void explicitWaitMethod(WebElement element, String attribute, String value) {

        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(5));
        wait.until(ExpectedConditions.attributeContains(element, attribute, value));
    }

    public void scrollToElement(String scrollElement) {
        driver.findElement(AppiumBy.androidUIAutomator(
                "new UiScrollable(new UiSelector()).scrollIntoView(text(\"" + scrollElement + "\"))"));
    }

    public void scrollToEndAction(int left, int top, int width, int height) {
    ...
    public void selectDropDownValueBasedOnText(String locator, String value) {
